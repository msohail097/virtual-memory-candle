      ...
      child: Scaffold(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: new AssetImage( "assets/images/CandleTypes/Top_band_Jewish.png",),
                      fit: BoxFit.fill
                  ),
                  //color: Colors.red
                ),
        ...
        Container(
          ...
          child: Column(
            ...
            Text('The Yiddish word, " Yahrzeit" literally means " time of one year" and is the word commonly used to refer to the anniversary date of the death of a family member.',
                style: GoogleFonts.zillaSlab(
                  textStyle: TextStyle(
                      fontSize: 14*
                          MediaQuery.textScaleFactorOf(
              ...
              Text('We honor our deceased family members by acts of remembrance, including the lighting of a candle on the anniversary on their death.',
                style: GoogleFonts.zillaSlab(
                  textStyle: TextStyle(
                      fontSize: 14*
                          MediaQuery.textScaleFactorOf(
              ...
              Text('Yizkor, which means " remembrance” refers to memorial prayer services held four times a year during Yom Kippur, the last (8th) day of Sukkot, the last (8th) day of Passover and the last (2nd) day of Shavuot.',
                  style: GoogleFonts.zillaSlab(
                      textStyle: TextStyle(
                          fontSize: 14*
                              MediaQuery.textScaleFactorOf(
              ...
              Text('Virtual Yahrzeit offers an alternative method of remembering your loved ones. We send you reminders on the anniversary of the death of your loved ones along with a link to your candle. Once activated, your Yahrzeit will burn on your app for 24-hours.',
                  style: GoogleFonts.zillaSlab(
                      textStyle: TextStyle(
                          fontSize: 14*
                              MediaQuery.textScaleFactorOf(
